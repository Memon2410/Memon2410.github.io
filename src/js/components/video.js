class Video {
  ...
  initVideo () {
    ...
    const SETTINGS = {
      ...
      artPainting: '../images/content/general/bill.png', // initial art painting
      detectState: {x:0.22,y:0.045,s:0.138,ry:-0.055}, // detect state in the initial art painting to avoid search step
    ...
    function main(){
      ...
      JEEFACEFILTERAPI.init({
        ...
        NNCPath: './helpers/neuralNet/', // root of NN_DEFAULT.json file
